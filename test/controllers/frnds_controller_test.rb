...
class FrndsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frnd" do
    assert_difference('Frnd.count') do
      post frnds_url, params: { frnd: { : @frnd., email: @frnd.email, first_name: @frnd.first_name, l_name: @frnd.l_name, phone: @frnd.phone, twitter: @frnd.twitter } }
    end
  ...
  test "should update frnd" do
    patch frnd_url(@frnd), params: { frnd: { : @frnd., email: @frnd.email, first_name: @frnd.first_name, l_name: @frnd.l_name, phone: @frnd.phone, twitter: @frnd.twitter } }
